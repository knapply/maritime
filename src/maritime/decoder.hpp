...
class Decoder {
 ...
 public:
  ...
  static Decoder from_file(const std::string& file_path) {
    return Decoder(NMEA_Stream::from_file(file_path));
  };
...
inline SEXP decode_filter_file(const std::string& file_path,
  ...
  for (std::size_t i = 0; i < total_messages; ++i) {
    ...
    const libais_T msg(nmea.payload.data.c_str(), nmea.fill_bits);
    out.push(msg, nmea.time_start, nmea.time_end);
  }
  ...
  for (std::size_t i = 0; i < total_messages; ++i) {
    ...
    switch (get_msg_type(nmea.payload)) {
      case MSG_TYPE::msg_1_2_3:
        msgs_1_2_3.push(                                 //
            libais::Ais1_2_3(nmea.payload.data.c_str(),  //
                             nmea.fill_bits),            //
      ...
      case MSG_TYPE::msg_4_11:
        msgs_4_11.push(                                 //
            libais::Ais4_11(nmea.payload.data.c_str(),  //
                            nmea.fill_bits),            //
            nmea.time_start, nmea.time_end              //
        );
        break;
      ...
      case MSG_TYPE::msg_5:
        msgs_5.push(                                 //
            libais::Ais5(nmea.payload.data.c_str(),  //
                         nmea.fill_bits),            //
            nmea.time_start, nmea.time_end           //
        );
        break;
      ...
      case MSG_TYPE::msg_7_13:
        msgs_7_13.push(                                 //
            libais::Ais7_13(nmea.payload.data.c_str(),  //
                            nmea.fill_bits),            //
            nmea.time_start, nmea.time_end              //
        );
        break;
      ...
      case MSG_TYPE::msg_9:
        msgs_9.push(                                 //
            libais::Ais9(nmea.payload.data.c_str(),  //
                         nmea.fill_bits),            //
            nmea.time_start, nmea.time_end           //
        );
        break;
      ...
      case MSG_TYPE::msg_10:
        msgs_10.push(                                 //
            libais::Ais10(nmea.payload.data.c_str(),  //
                          nmea.fill_bits),            //
            nmea.time_start, nmea.time_end            //
        );
        break;
